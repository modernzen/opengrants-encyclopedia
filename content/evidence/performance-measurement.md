---
title: "Performance Measurement and Indicators"
slug: "performance-measurement"
url: "/encyclopedia/evidence/performance-measurement/"
hub: "evidence"
hubUrl: "/encyclopedia/evidence/"
articleType: "concept"
schemaType: "Article"

metaDescription: "How to choose grant performance measures: indicator criteria, leading vs lagging, setting defensible targets, collection cost, and what reporting does to them later."
primaryEntity: "Performance Measurement"
primaryQuestion: "How do you choose performance measures for a grant?"
secondaryQuestions:
  ...
  - "How do you set a performance target?"
  - "How many performance measures should a grant have?"
  - "What is a baseline in a grant proposal?"
  - "What happens if you miss a performance target?"
definedTerms: ["performance-measure", "performance-target", "baseline", "leading-indicator", "lagging-indicator", "benchmark"]
...
volatileFacts:
  - item: "Federal performance report frequency"
    value: "no less frequent than annually nor more frequent than quarterly, absent a specific condition"
    source: "https://www.ecfr.gov/current/title-2/section-200.329"
    verified: "2026-08-11"
  - item: "Annual performance report deadline"
    value: "no later than 90 calendar days after the reporting period"
    source: "https://www.ecfr.gov/current/title-2/section-200.329"
    verified: "2026-08-11"
  - item: "Quarterly or semiannual performance report deadline"
    value: "no later than 30 calendar days after the reporting period"
    source: "https://www.ecfr.gov/current/title-2/section-200.329"
    verified: "2026-08-11"
  - item: "Final performance report deadline"
    value: "no later than 120 calendar days after the period of performance"
    source: "https://www.ecfr.gov/current/title-2/section-200.329"
    verified: "2026-08-11"
  - item: "Subrecipient final performance report deadline"
    value: "no later than 90 calendar days after the subrecipient's period of performance"
    source: "https://www.ecfr.gov/current/title-2/section-200.329"
    verified: "2026-08-11"
...
> | Item | Value | Source |
> |---|---|---|
> | Performance report frequency | no less frequent than annually, no more frequent than quarterly, absent a specific condition | [2 CFR 200.329](https://www.ecfr.gov/current/title-2/section-200.329) |
> | Annual performance report deadline | 90 calendar days after the reporting period | [2 CFR 200.329](https://www.ecfr.gov/current/title-2/section-200.329) |
> | Quarterly or semiannual report deadline | 30 calendar days after the reporting period | [2 CFR 200.329](https://www.ecfr.gov/current/title-2/section-200.329) |
> | Final performance report deadline | 120 calendar days after the period of performance | [2 CFR 200.329](https://www.ecfr.gov/current/title-2/section-200.329) |
> | Subrecipient final performance report | 90 calendar days after the subrecipient's period of performance | [2 CFR 200.329](https://www.ecfr.gov/current/title-2/section-200.329) |
>
...
A performance measure in a grant is a quantitative indicator used to track how a project is doing. Federal education regulations define it as "any quantitative indicator, statistic, or metric used to gauge program or project performance" ([34 CFR 77.1](https://www.ecfr.gov/current/title-34/subtitle-A/part-77/section-77.1)). Measures live in the application, in progress reports, and in the funder's own accountability systems.

Performance measurement is not evaluation, and the distinction decides what a proposal owes. The Centers for Disease Control and Prevention draws the line cleanly: performance measurement is "the ongoing monitoring and reporting of program accomplishments, particularly progress toward pre-established goals," while program evaluation "helps you to identify the reason behind these changes and potential areas of improvement" ([CDC](https://www.cdc.gov/evaluation/php/about/index.html)). Federal guidance treats the two as separate components of evidence, alongside foundational fact-finding and policy analysis ([OMB M-19-23](https://www.whitehouse.gov/wp-content/uploads/2019/07/M-19-23.pdf)). The published federal evaluation framework places measurement inside a wider cycle of assessing context, focusing the design, and using what is learned ([CDC Program Evaluation Framework, 2024](https://www.cdc.gov/mmwr/volumes/73/rr/rr7306a1.htm)).
...
Performance measurement also sits downstream of program logic. Measures should attach to specific boxes in the project's [logic model](/encyclopedia/evidence/logic-models/), and every box that matters should carry a measure. Within [evidence, evaluation, and data](/encyclopedia/evidence/), the measurement plan is where a program design becomes something a funder can verify.
...
A performance indicator is the thing being measured; a target is the value the applicant commits to reaching. The regulations separate them explicitly, defining a performance target as "a level of performance that an applicant would seek to meet during the course of a project or as a result of a project" and a baseline as "the starting point from which performance is measured and targets are set" ([34 CFR 77.1](https://www.ecfr.gov/current/title-34/subtitle-A/part-77/section-77.1)).
...
Setting a defensible target draws on three anchors rather than optimism. The first is your own historical trend on the same measure, same population, same definition. The second is an external benchmark — the district, county, state, or national value — which the selection criteria reward by asking for "a comparison to local, State, regional, national, or international data" ([34 CFR 75.210](https://www.ecfr.gov/current/title-34/section-75.210)). The third is the effect size observed in the research cited for the project's [level of evidence](/encyclopedia/evidence/levels-of-evidence/), which bounds what the intervention has actually produced elsewhere.
...
Selection is also a step in the improvement cycle federal guidance describes — identify local needs, select relevant evidence-based components, plan for implementation, implement, then examine and reflect ([Using Evidence to Strengthen Education Investments](https://www2.ed.gov/fund/grant/about/discretionary/2023-non-regulatory-guidance-evidence.pdf)). Measures that cannot support the examine-and-reflect step are measures that only generate paperwork.

The regulations reward this discipline rather than volume. Department of Education criteria credit projects that propose "specific, measurable targets, connected to strategies, activities, resources, outputs, and outcomes" and that use "reliable administrative data to measure progress and inform continuous improvement" ([34 CFR 75.210](https://www.ecfr.gov/current/title-34/section-75.210)). Connectedness is the standard, not count.
...
Performance reporting runs alongside financial reporting, which uses a separate government-wide form and its own cycle ([2 CFR 200.328](https://www.ecfr.gov/current/title-2/section-200.328)). Agencies are told to align the due dates where practicable, and the performance report is where accomplishments and expenditures are expected to be related to each other.

Documentation is what turns reported numbers into defensible ones. Monitors and auditors ask for the source records behind a reported figure, the written definition of each measure, the query or extract logic used, the dates of the pull, and the review step that approved the number before submission. Keeping that packet per reporting period is ordinary practice for organizations with functioning [grant reporting requirements](/encyclopedia/award-management/grant-reporting-requirements/), and it is the difference between a question and a finding.
...
- [Evidence, Evaluation, and Data](/encyclopedia/evidence/) — the hub covering logic models, evaluation design, measurement, and data
- [Outputs, Outcomes, and Impact](/encyclopedia/evidence/outputs-vs-outcomes/)
- [Writing an Evaluation Plan](/encyclopedia/evidence/writing-an-evaluation-plan/)
- [Levels of Evidence in Grant Funding](/encyclopedia/evidence/levels-of-evidence/)
- [Goals, Objectives, and Activities](/encyclopedia/proposal-craft/goals-and-objectives/)
...
3. Office of Management and Budget, 2 CFR 200.329, "Monitoring and reporting program performance" (eCFR). https://www.ecfr.gov/current/title-2/section-200.329 (accessed 2026-08-11)
4. Office of Management and Budget, 2 CFR 200.328, "Financial reporting" (eCFR). https://www.ecfr.gov/current/title-2/section-200.328 (accessed 2026-08-11)
5. Centers for Disease Control and Prevention, "CDC Approach to Program Evaluation." https://www.cdc.gov/evaluation/php/about/index.html (accessed 2026-08-11)
