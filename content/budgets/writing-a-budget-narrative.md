---
title: "Writing a Budget Narrative"
slug: "writing-a-budget-narrative"
url: "/encyclopedia/budgets/writing-a-budget-narrative/"
hub: "budgets"
hubUrl: "/encyclopedia/budgets/"
articleType: "process"
schemaType: "Article"

metaDescription: "A budget narrative shows the derivation, necessity, and allowability of every proposed cost. How to write one line by line, with the arithmetic shown."
primaryEntity: "Budget narrative"
primaryQuestion: "How do you write a budget narrative?"
secondaryQuestions:
  - "What is a budget justification?"
  - "What should a budget narrative include for each line?"
  - "How do you justify personnel effort in a grant budget?"
  - "How do you justify travel costs on a federal grant?"
  - "How do you justify equipment purchases in a grant budget?"
  - "What is a basis of estimate?"
  - "How do reviewers check a budget against the project narrative?"
  - "What are the most common budget narrative mistakes?"
definedTerms: ["budget-narrative", "basis-of-estimate", "person-months", "modified-total-direct-cost", "participant-support-costs"]

clusterSiblings:
  - "grant-budget-anatomy"
  - "allowable-costs"
  - "indirect-cost-rates"
...
volatileFacts:
  - item: "De minimis indirect cost rate"
    value: "up to 15 percent of modified total direct costs"
    source: "https://www.ecfr.gov/current/title-2/section-200.414"
    verified: "2026-08-11"
  - item: "Equipment definition threshold"
    value: "per-unit acquisition cost equal to or above the lesser of the entity's own capitalization level or $10,000"
    source: "https://www.ecfr.gov/current/title-2/subtitle-A/chapter-II/part-200/subpart-A/section-200.1"
    verified: "2026-08-11"
  - item: "Prior written approval trigger for special purpose equipment"
    value: "unit cost of $10,000 or more"
    source: "https://www.ecfr.gov/current/title-2/section-200.439"
    verified: "2026-08-11"
  - item: "Subaward amount included in the MTDC base"
    value: "the first $50,000 of each subaward"
    source: "https://www.ecfr.gov/current/title-2/subtitle-A/chapter-II/part-200/subpart-A/section-200.1"
    verified: "2026-08-11"
...
> | Item | Value | Source |
> |---|---|---|
> | De minimis indirect cost rate | Up to 15 percent of modified total direct costs | [2 CFR 200.414(f)](https://www.ecfr.gov/current/title-2/section-200.414) |
> | Equipment definition threshold | Per-unit cost at or above the lesser of the entity's capitalization level or $10,000 | [2 CFR 200.1](https://www.ecfr.gov/current/title-2/subtitle-A/chapter-II/part-200/subpart-A/section-200.1) |
> | Prior written approval for special purpose equipment | Unit cost of $10,000 or more | [2 CFR 200.439(b)](https://www.ecfr.gov/current/title-2/section-200.439) |
> | Subaward amount included in the MTDC base | The first $50,000 of each subaward | [2 CFR 200.1](https://www.ecfr.gov/current/title-2/subtitle-A/chapter-II/part-200/subpart-A/section-200.1) |
>
...
- **Published rates.** Federal per diem and lodging rates published by the General Services Administration, mileage rates, published tuition, published conference registration fees ([GSA per diem rates](https://www.gsa.gov/travel/plan-a-trip/per-diem-rates)).
...
>
> **Weak — personnel**
> Program Manager: $44,000.
>
> **Strong — personnel**
> Program Manager (TBD), 0.35 FTE (4.2 calendar months). Institutional base salary $96,000 per year, per FY25 payroll records; requested salary $96,000 × 0.35 = $33,600. Fringe at the organization's computed rate of 31 percent, per the FY25 audited fringe computation: $33,600 × 0.31 = $10,416. Total $44,016. The Program Manager supervises the three site coordinators, runs the monthly partner convening described in Objective 2, and produces the quarterly data submission described in Objective 4.
>
> **Weak — travel**
> Travel: $9,000.
>
> **Strong — travel**
> Site monitoring travel: 2 staff × 3 trips × 2 nights. Airfare $340 per round trip (average of three carrier quotes obtained 2026-04-02, basic economy). Lodging and meals at the published federal per-diem rate for the destination city, $189 lodging plus $79 meals and incidentals per day. Per trip: $340 + (2 × $189) + (3 × $79) = $955. Total: 2 × 3 × $955 = $5,730. Trips support the on-site fidelity reviews in Objective 3.
>
> **Weak — equipment**
> Equipment: $18,000.
>
> **Strong — equipment**
> One benchtop analyzer, $17,850 per written quote from [vendor], dated 2026-03-18. The unit exceeds the organization's $5,000 capitalization level and is therefore classified as equipment and excluded from the MTDC base. The existing analyzer processes 40 samples per day; the sampling plan in Objective 2 requires 110 per day. Prior written approval is requested per 2 CFR 200.439.
...
Alignment is also where the [project design](/encyclopedia/proposal-craft/project-design-and-methodology/) and the budget stop being separate documents. If the alignment check forces a change, change the design and the budget together rather than papering over the gap in the narrative.
...
- [Budgets and Grant Finance](/encyclopedia/budgets/) — the hub for cost categories, indirect rates, match, and cash mechanics
- [The Anatomy of a Grant Budget](/encyclopedia/budgets/grant-budget-anatomy/)
- [Allowable, Allocable, and Reasonable Costs](/encyclopedia/budgets/allowable-costs/)
- [Indirect Cost Rates and the De Minimis Option](/encyclopedia/budgets/indirect-cost-rates/)
- [Building a Compliance Matrix](/encyclopedia/proposal-craft/compliance-matrix/)
...
12. National Institutes of Health, Application Guide G.320, "PHS 398 Modular Budget Form." https://grants.nih.gov/grants/how-to-apply-application-guide/forms-e/general/g.320-phs-398-modular-budget-form.htm (accessed 2026-08-11)
